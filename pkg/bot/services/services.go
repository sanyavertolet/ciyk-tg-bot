...
func OpenGamesRegistrations(repo *database.Repository) []model.Game {
...
func SyncGames(repo *database.Repository, sheetsService *sheets.Sheets) {
	sheetsService.SyncGames(repo)
	OpenGamesRegistrations(repo)
}
